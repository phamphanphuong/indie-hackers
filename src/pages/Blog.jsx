...
const posts = [
  ...
  {
    slug: 'post2',
    title: 'Xây Dựng MVP Đầu Tiên: Bí Quyết Thành Công Cho Indie Hacker Mới',
    desc: 'Chào mọi người! Trong video này, mình sẽ chia sẻ kinh nghiệm thực tế về việc xây dựng Minimum Viable Product (MVP) đầu tiên. Đây là bước quan trọng nhất quyết định thành công của một indie hacker. Mình đã thất bại 3 lần trước khi học được cách làm đúng.',
  },
  {
    slug: 'post3',
    title: 'Marketing & Growth: Cách Thu Hút 1000 Users Miễn Phí',
